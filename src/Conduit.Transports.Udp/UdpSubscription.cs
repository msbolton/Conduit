...
{
    /// <summary>
    /// Represents a subscription to UDP messages.
    /// </summary>
    public class UdpSubscription : ITransportSubscription
    {
        ...
        {
            if (_isDisposed)
                throw new ObjectDisposedException(nameof(UdpSubscription));

            _logger.LogInformation("Pausing UDP subscription {SubscriptionId}", Id);
            _isPaused = true;
        ...
        public Task ResumeAsync()
        {
            ...
            _logger.LogInformation("Resuming UDP subscription {SubscriptionId}", Id);
            _isPaused = false;
            return Task.CompletedTask;
        }
        ...
        public async Task UnsubscribeAsync(CancellationToken cancellationToken = default)
        {
            ...
            _logger.LogInformation("Unsubscribing UDP subscription {SubscriptionId}", Id);
        ...
        internal async Task HandleMessageAsync(TransportMessage message)
        {
            ...
            {
                _logger.LogError(ex, "Error handling UDP message {MessageId} in subscription {SubscriptionId}",
        ...
        public async ValueTask DisposeAsync()
        {
            ...
            _logger.LogInformation("UDP subscription {SubscriptionId} disposed", Id);
